...
export default defineComponent({
  ...
  props: {
    ...
    maxHeight: propTypes.oneOfType([Number, String]).def('75vh'),
    ...
    wrapperShadow: propTypes.bool.def(false),
    ...
    scrollbarAlwaysOn: propTypes.bool.def(true),
  ...
  setup(props, { attrs, emit, slots, expose }) {
    ...
    return () => {
      ...
      if (getSlot(slots, 'default')) {
        tableSlots['default'] = (...args: any[]) => getSlot(slots, 'default', args)
      }
      return (
        <div
          class={[`my-table`, { 'my-table--shadow': props.wrapperShadow }]}
        ...
        >
          ...
          <div class="my-table__inner">
            {slots.title?.() && <div class="my-table__title">{slots.title?.()}</div>}
