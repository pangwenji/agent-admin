...
import OperatePassword from './OperatePassword.vue'
        ...
        <div
          class={[
            ...
            'w-full',
            {
              ...
              'h-[calc(100%-var(--app-footer-height)-var(--top-tool-height))]': true
            }
          ]}
        >
          <div
            ...
            class={[
              ...
              'h-100%',
              {
                // '!pb-[calc(var(--tags-view-height)+var(--app-footer-height))]': true
